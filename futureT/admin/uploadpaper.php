<?php
      ...
      $table="";
      $query = "SELECT *FROM paper WHERE is_deleted=0";
      $result = mysqli_query($con,$query);
                  ...
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <br><br>
                              <form class="forms-sample" method="post" action="../phpModel/uploadPaper.php" enctype="multipart/form-data">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                                <input type="file" name="paper_file" class="form-control" id="exampleInputMobile" required  >
                                          </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="owner_name" class="form-control" id="exampleInputUsername2" placeholder="Owner of the note" required >
                                        </div>
                                    </div>
