<?php
      ...
      $table="";
      $query = "SELECT *FROM banner WHERE is_deleted=0";
      $result = mysqli_query($con,$query);
      ...
      if (mysqli_num_rows($result) > 0) {
          ...
          while ($rows = mysqli_fetch_assoc($result)) {
              ...
              $table.="<td>"."<a href='edituploadbanners.php?banner_id=".$rows['id']."'><span class='mdi mdi-eyedropper ' style='color:green;font-size:14px;''> Edit</span></a>".
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              <h4 class="card-title">Update Banner Details</h4>
                              <!-- <p class="card-description"> Horizontal form layout </p> -->
                              <br><br>
                              <form class="forms-sample" method="post" action="../phpModel/updateBanner.php" enctype="multipart/form-data">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <?php endif; ?>  
                                    <input type="hidden" name="banner_id" value=<?php echo $b_id; ?>>
                                    <div class="form-group row">
                                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Title</label>
                                        <div class="col-sm-9">
                                            <label for="exampleInputUsername2" class="col-sm-6 col-form-label"><?php echo $title; ?></label>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Student Level</label>
                                          <div class="col-sm-9">
                                              <label for="exampleInputEmail2" class="col-sm-3 col-form-label"><?php echo $student_level; ?></label>
                                          </div>
                                    </div>
                                    
                                    <font color="green">If you want to change student level the you can try bellow</font><br><br>
                                    <div class="form-group row">

                                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Student Level</label>
                                        <div class="col-sm-9">
                                    ...
                                    <button type="submit" class="btn btn-gradient-primary mr-2" name="ub_upload">Update</button>
