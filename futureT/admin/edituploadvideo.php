                  ...
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <br><br>
                              <form class="forms-sample" method="post" action="../phpModel/updateVideo.php" enctype="multipart/form-data">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="owner_name" class="form-control" id="exampleInputUsername2" placeholder="Owner of the video" required value=<?php echo $owner_name; ?>>
                                        </div>
                                    </div>
