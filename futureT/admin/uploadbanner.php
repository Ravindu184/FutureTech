          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              <h4 class="card-title">Upload Banner Details</h4>
                              <!-- <p class="card-description"> Horizontal form layout </p> -->
                              <br><br>
                              <form class="forms-sample" method="post" action="../phpModel/uploadBanner.php" enctype="multipart/form-data">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <div class="form-group row">
                                          <label for="exampleInputMobile" class="col-sm-3 col-form-label">Banner file</label>
                                          <div class="col-sm-9">
                                                <input type="file" name="banner_file" class="form-control" id="exampleInputMobile" required  >
                                          </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <button type="submit" class="btn btn-gradient-primary mr-2" name="b_upload">Upload</button>
