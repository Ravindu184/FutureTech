                  ...
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <br><br>
                              <form class="forms-sample" method="post" action="../phpModel/uploadNote.php" enctype="multipart/form-data">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                                <input type="file" name="note_file" class="form-control" id="exampleInputMobile" required  >
                                          </div>
                                    </div>
                                    <div class="form-group row">
