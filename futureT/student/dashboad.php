<?php
      ...
      $query = "SELECT *FROM banner WHERE student_level='$usr_type' OR student_level='all' AND is_deleted=0";
      $result = mysqli_query($con,$query);

      if (mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
              
              $banners.="<div class=col-md-6>";
                  $banners.="<div class='card'>";
                      $banners.="<div class='card-body'>";
                          $banners.="<img src=../admin/uploads/banner/".$row['banner_file']." width='100%' height='30%'>";
                      $banners.="</div>";
                  $banners.="</div>";
              $banners.="</div>";
          }
...
<html lang="en">
  <head>
    ...
    <title>Future Tech Student</title>
    <!-- plugins:css -->
            ...
            <div class="row" id="proBanner">
              <div class="col-12">
                <span class="d-flex align-items-center purchase-popup">
                  <p>Hello!!.. <?php echo "<b>".$name."</b>"; ?> Welcome to Student Panel</p>
