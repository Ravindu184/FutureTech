<?php
      ...
      if (isset($_SESSION['user_id'])) {
          ...
          $query = "SELECT *FROM paper WHERE student_level =$type";
          ...
          if ($num_of_rows > 0) {
              ...
              {
                  $papers.="<div class='col-md-3 mt-4'>";
                    $papers.="<div class='card'>";
                      $papers.="<div class='card-header bg-gradient-primary' style='color:white;'>"."<b>".$row['title']."</b>"."</div>";
                      $papers.="<div class='card-body'>";
                          $papers.="<center>"."<img src=../img/pdf.png width=100px height=100px>"."</center>";
                          $papers.="<p class='mt-2'>".$row['description']."</p>";
                          $papers.="<center>"."<a href='view2.php?p_code={$row['id']}'>"."<button class='btn bg-gradient-primary' style='color:white;'>Download</button>"."</a>"."</center>";
                      $papers.="</div>";
                      $papers.="<div class='card-footer'>";
                          $papers.="<h5>"."දේශක ".$row['owner']."</h5>";
                      $papers.="</div>";
                    $papers.="</div>";
                  $papers.="</div>";
