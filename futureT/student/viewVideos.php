<?php
      ...
      if (isset($_SESSION['user_id'])) {
          ...
          $query = "SELECT *FROM video WHERE student_level =$type";
          ...
          if ($num_of_rows > 0) {
              ...
              {
                  $Videos.="<div class='col-md-3 mt-4'>";
                    $Videos.="<div class='card'>";
                      $Videos.="<div class='card-header bg-gradient-primary' style='color:white;'>"."<b>".$row['title']."</b>"."</div>";
                      $Videos.="<div class='card-body'>";
                          $Videos.="<center>"."<img src=../admin/uploads/video/".$row['thubmail']." width=230px height=140px>"."</center>";
                          $Videos.="<p class='mt-2'>".$row['description']."</p>";
                          $Videos.="<center>"."<a href=".$row['video_link'].">"."<button class='btn btn-primary'>Learn</button>"."</a>"."</center>";
                      $Videos.="</div>";
                      $Videos.="<div class='card-footer'>";
                          $Videos.="<h5>"."දේශක ".$row['owner']."</h5>";
                      $Videos.="</div>";
                    $Videos.="</div>";
                  $Videos.="</div>";
