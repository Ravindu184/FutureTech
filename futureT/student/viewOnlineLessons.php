<?php
      ...
      if (isset($_SESSION['user_id'])) {
          ...
          $query = "SELECT *FROM online_lessons WHERE student_level =$type";
          ...
          if ($num_of_rows > 0) {
              ...
              {
                  $onlineSessions.="<div class='col-md-3 mt-4'>";
                    $onlineSessions.="<div class='card'>";
                      $onlineSessions.="<div class='card-header bg-gradient-primary' style='color:white;'>"."<b>".$row['lesson_name']."</b>"."</div>";
                      $onlineSessions.="<div class='card-body'>";
                          $onlineSessions.="<center>"."<img src=../img/zoom.png width=140px height=120px>"."</center>";
                          $onlineSessions.="<center>"."<p class='mt-2'>".$row['description']."</p>"."</center>";
                          $onlineSessions.="<center>"."<p>".$row['d_date']." දින"."</p>"."</center>";
                          $onlineSessions.="<center>"."<p>"."වේලාව ".$row['d_time']." ට"."</p>"."</center>";
                          $onlineSessions.="<center>"."<a href=".$row['lesson_link'].">"."<button class='btn btn-primary'>Join</button>"."</a>"."</center>";
                      $onlineSessions.="</div>";
